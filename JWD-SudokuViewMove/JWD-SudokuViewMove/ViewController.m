...
- (void)setUpData{
    ...
    JWDSudoKuView *scrollView = [[JWDSudoKuView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth, KScreenHeight) withItemTitleArray:self.itemTitleArray withItemTagArray:self.itemTagArray isAnimation:NO];
...
//    NSLog(@"只是点击了");
////    NSInteger  = [tag integerValue];
////    NSLog(@"itemTitleArray---tag %d  title %@ -- imageName %@",tag,self.itemTitleArray[tag][@"title"],self.itemTitleArray[tag][@"imageName"]);
//}
//
